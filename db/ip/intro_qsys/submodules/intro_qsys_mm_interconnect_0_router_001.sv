...
(
    ...
    localparam PAD8 = log2ceil(64'h10000040 - 64'h10000000); 
    localparam PAD9 = log2ceil(64'h11000008 - 64'h11000000); 
    // -------------------------------------------------------
    ...
    // ( 0x1000 .. 0x1020 )
    if ( {address[RG:PAD1],{PAD1{1'b0}}} == 29'h1000   ) begin
    ...
    if ( {address[RG:PAD9],{PAD9{1'b0}}} == 29'h11000000   ) begin
